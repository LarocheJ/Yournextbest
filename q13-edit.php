<?php
    ...
    $sql = "SELECT consequence_face FROM users WHERE email=?";
...
<div class="wrapper">
    ...
    <div class="fade-2">
        <div class="edit-wrapper">
            <form class="form-edit" action="q13-edit-confirm.php" method="post">
                <!-- QUESTION 13 -->
                <div class="text-area-container">
                    <label for="consequence">
                        <p class="form-questions"><?php print $q13 ?></p>
                    </label>
                    <textarea name="consequence" id="consequence" cols="50" rows="5"
                        placeholder="Enter your answer here..." required><?php 
                            ...
                            if($result){
                                while($row = mysqli_fetch_array($result)){
                                    print stripslashes($row['consequence_face']);
                                } 
                            } else {
                                print 'No data';
                            }
