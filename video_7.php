...
<div class="upper-video">
    ...
    <div class="video-wrapper">
        <h1 class="page-heading">Episode 7: Students</h1>
        <video controls id="ynb-video">
            <source src="videos/compressed/A52_your_next_best_ep7.mp4">
            <source src="videos/compressed/A52_your_next_best_ep7.mkv">
...
?>
    ...
    <div class="form-wrapper fade-2">
        ...
        <div class="form-hide" id="userForm">
            <form action="video_7_confirm.php" method="post">
                ...
                <div class="text-area-container">
                    <label for="impact">
                        <p class="form-questions"><?php print $q15 ?></p>
                    </label>
                    <textarea name="impact" id="impact" cols="50" rows="5" placeholder="Enter your answer here..."
                        required></textarea>
                </div>
    ...
    <div class="align-center">
        <?php 
                ...
                if($result){
                    while($row = mysqli_fetch_array($result)){
                        if($row['impact'] != ""){
                            print '<a href="video_8.php" class="main-btn">Next Video</a>';
